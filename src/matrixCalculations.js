...
const multiplicationHelper = (r, c, commonExtent, a, b) => {
...
const getSubMatrix = (i, j, dimensionSize, a) => {
...
const determinantHelper = a => {
  ...
  for (let r = 0; r < dimensionSize; ++r) {
    ...
    let subMatrix = getSubMatrix(r, 0, dimensionSize, a);
    // Accumulate the determinant for Matrix a, making a recursive call passing that subMatrix.
    determinantResult +=
      Math.pow(-1, r) * a[r][0] * determinantHelper(subMatrix);
  }
...
const printMatrix = sampleMatrix => {
  let printed = "";
