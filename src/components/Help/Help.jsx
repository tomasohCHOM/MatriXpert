    ...
    <>
      <nav className={`help-container ${isOpen === true ? "active" : ""}`}>
        ...
        <p className="help-contents">
          ...
          students struggle with when then encounter Linear Algebra for the
          first time.
        </p>
        ...
        <p className="help-contents">
          ...
          automatically be evaluated to 0). Finally, press the Calculate button
          to display the result of your chosen operation, along with some
          further explanations as to how the result is calculated.
        </p>
      </nav>
      <div
